...
$HTTP_CLIENT $tmp_dir/intro.txt https://github.com/youngker/emacs.d/raw/master/installer/intro.txt
$HTTP_CLIENT $tmp_dir/outro.txt https://github.com/youngker/emacs.d/raw/master/installer/outro.txt
...
function download_tarball {
     ...
     echo ""
     $HTTP_CLIENT $tmp_dir/live.zip https://github.com/youngker/emacs.d/zipball/master
...
function git_clone {
     ...
     echo ""
    git clone https://github.com/youngker/emacs.d.git $tmp_dir/overtone-emacs-live
}
